...
def showGraphUCS(nodes, graph, path, coordinates):
    print("Showing graph...")
...
def showMap(nodes, graph, path, coordinates):
    ...
    gmap = gmplot.GoogleMapPlotter(avg_lat, avg_lng, apikey="AIzaSyB5UAh67qqEWkt8i2VH6AMD3KJgIdx4vNI", use_api=True, map_type='terrain', zoom=14, title="My Map")
